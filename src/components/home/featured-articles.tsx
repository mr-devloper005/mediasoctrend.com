          ...
          {hero && (
            ...
            >
              <div className="relative aspect-[16/9] overflow-hidden">
                <Image
                  src={hero.coverImage || 'https://img.freepik.com/free-photo/business-team-meeting-boardroom_23-2149095375.jpg'}
                  alt={hero.title}
                  fill
          ...
          <div className="grid gap-6">
            {[second, third].filter(Boolean).map((article) => (
              ...
              >
                <div className="relative aspect-[16/9] overflow-hidden">
                  <Image
                    src={article!.coverImage || 'https://img.freepik.com/free-photo/business-team-meeting-boardroom_23-2149095375.jpg'}
                    alt={article!.title}
                    fill
